							...
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<form class="form-horizontal form-label-left input_mask"
										action="${pageContext.request.contextPath}/chance_add"
										method="post">
										<div class="col-sm-6 col-md-12 col-xs-6">
											<div
												...
												<input class="form-control has-feedback-left"
													name="chance.chan_name" placeholder="商机名称" align="left" />
											...
											<div
												...
												<div class="col-md-3 col-sm-6 col-xs-6 has-feedback" >
													<select class='form-control' id = "chance_option_type" onchange="getOptions(this.value,'add_chance_type_div','chance.chan_type.dict_id',null)">
												...
												<div id="add_chance_type_div" class="col-md-3 col-sm-6 col-xs-6 has-feedback"></div>
											<div
												class="col-md-6 col-sm-12 col-xs-12 form-group has-feedback">
