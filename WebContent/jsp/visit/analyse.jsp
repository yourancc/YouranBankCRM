			...
			<div class="main_container">
				...
				<div class="right_col" role="main">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>客户行业分析 <small>客户行业分析</small></h2>
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>客户来源分析<small>客户来源分析</small></h2>
							...
							<div class="x_content"><iframe class="chartjs-hidden-iframe" style="width: 100%; display: block; border: 0px; height: 0px; margin: 0px; position: absolute; left: 0px; right: 0px; top: 0px; bottom: 0px;"></iframe>
								<canvas id="customer_source_analyse_id" width="532" height="266" style="width: 532px; height: 266px;"></canvas>
							</div>
						</div>
					</div>
					<!-- 新增客户分析 -->
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>新增客户分析<small>新增客户分析</small></h2>
								<ul class="nav navbar-right panel_toolbox">
									<li>
										<a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
									</li>
							...
							<div class="x_content"><iframe class="chartjs-hidden-iframe" style="width: 100%; display: block; border: 0px; height: 0px; margin: 0px; position: absolute; left: 0px; right: 0px; top: 0px; bottom: 0px;"></iframe>
								<canvas id="customer_add_analyse_id" width="532" height="266" style="width: 532px; height: 266px;"></canvas>
							</div>
						</div>
					</div>
